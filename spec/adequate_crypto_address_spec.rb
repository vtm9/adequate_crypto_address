RSpec.describe(AdequateCryptoAddress) do
  describe '.valid?' do
    it 'returns true for correct Bitcoin addresses' do
      # hash160 addresses
    ...
    it 'returns true for correct Bitcoincash addresses' do
      # legacy_addreses
      ...
      expect(described_class).to be_valid('bchtest:qpqtmmfpw79thzq5z7s0spcd87uhn6d34uqqem83hf', :Bitcoincash, :P2PKH)
      expect(described_class).to be_valid('bchtest:pp8f7ww2g6y07ypp9r4yendrgyznysc9kqxh6acwu3', :BCH, :P2SH)

      # set default prefix bitcoincash
      ...
      expect(described_class).not_to be_valid('bad', :bch)
      expect(described_class).not_to be_valid('bitcoincash:bad', :bch)
      expect(described_class).not_to be_valid('bitcoincash:zz', :bch)
      expect(described_class).not_to be_valid('bitcoincash:123', :bch)
    end

    it 'returns true for correct Ethereum addresses' do
